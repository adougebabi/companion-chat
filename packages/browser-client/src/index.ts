...
export class BrowserClient {
  ...
  async activateFluctlightCreation(body: { requestId: string; initializationMode: "blank_slate" | "llm_defined"; name?: string; corePersona?: Record<string, unknown>; developingSelf?: Record<string, unknown>; initialGoals?: Array<Record<string, unknown>>; initialIntentions?: Array<Record<string, unknown>>; initialRelationships?: Array<Record<string, unknown>> }): Promise<{ id: string; core_persona?: Record<string, unknown>; identity: Record<string, unknown>; status: string }> { return this.json("/api/fluctlight-creations/activate", { method: "POST", body }) as Promise<{ id: string; core_persona?: Record<string, unknown>; identity: Record<string, unknown>; status: string }>; }
