...
export const browserOperations = ["/api/actor-groups","/api/actor-groups/{groupId}/members","/api/actor-groups/{groupId}/members/{actorId}","/api/autonomy-actions/{actionId}/govern","/api/conversations","/api/conversations/{conversationId}/messages","/api/conversations/{conversationId}/read","/api/conversations/{conversationId}/turn","/api/diagnostics","/api/diagnostics/export","/api/diagnostics/model-runs","/api/diagnostics/workflows","/api/diagnostics/workflows/{workflowId}/cancel","/api/diagnostics/workflows/{workflowId}/history","/api/diagnostics/workflows/{workflowId}/pause","/api/diagnostics/workflows/{workflowId}/reset","/api/diagnostics/workflows/{workflowId}/restart","/api/diagnostics/workflows/{workflowId}/resume","/api/diagnostics/workflows/{workflowId}/status","/api/fluctlight-creations/activate","/api/fluctlight-creations/analysis","/api/fluctlights","/api/fluctlights/{fluctlightId}","/api/fluctlights/{fluctlightId}/autonomy-actions","/api/fluctlights/{fluctlightId}/conversation","/api/fluctlights/{fluctlightId}/detail","/api/fluctlights/{fluctlightId}/events","/api/fluctlights/{fluctlightId}/events/{eventId}/cancel","/api/fluctlights/{fluctlightId}/foundation-revisions","/api/fluctlights/{fluctlightId}/foundation-revisions/rollback","/api/fluctlights/{fluctlightId}/foundation-revisions/{revisionId}/accept","/api/fluctlights/{fluctlightId}/foundation-revisions/{revisionId}/reject","/api/fluctlights/{fluctlightId}/moments","/api/fluctlights/{fluctlightId}/moments/read","/api/fluctlights/{fluctlightId}/presence","/api/fluctlights/{fluctlightId}/relationships/rollback","/api/fluctlights/{fluctlightId}/schedules","/api/fluctlights/{fluctlightId}/schedules/{scheduleId}/cancel","/api/fluctlights/{fluctlightId}/status","/api/media/{assetId}","/api/memories/{memoryId}","/api/memories/{memoryId}/forget","/api/moments","/api/moments/{momentId}/comments","/api/moments/{momentId}/hide","/api/moments/{momentId}/reactions","/api/moments/{momentId}/restore","/api/platform/ping","/api/providers","/api/providers/endpoints","/api/providers/endpoints/{endpointId}/models","/api/providers/roles","/api/settings","/auth/login","/auth/logout","/auth/password","/auth/revoke-all","/auth/session","/auth/setup","/auth/setup-status","/health/live","/health/ready"] as const;
...
export type BrowserDiagnosticModelRun = { id: string; role: string; endpointId?: string | null; modelId: string; prompt: Record<string, unknown>; response?: Record<string, unknown> | null; status: string; errorCode?: string | null; correlationId: string; createdAt: string };
...
export class BrowserClient {
  ...
  async activateFluctlightCreation(body: { requestId: string; initializationMode: "blank_slate" | "llm_defined"; identity: Record<string, unknown>; personality?: Record<string, unknown>; behavioralPolicy?: Record<string, unknown> }): Promise<{ id: string; identity: Record<string, unknown>; status: string }> { return this.json("/api/fluctlight-creations/activate", { method: "POST", body }) as Promise<{ id: string; identity: Record<string, unknown>; status: string }>; }
  async listFluctlights(): Promise<Array<{ id: string; identity: Record<string, unknown>; status: string; unread_count?: number }>> { return this.json("/api/fluctlights") as Promise<Array<{ id: string; identity: Record<string, unknown>; status: string; unread_count?: number }>>; }
