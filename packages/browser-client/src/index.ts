...
export const browserOperations = ["/api/conversations","/api/conversations/{conversationId}/messages","/api/conversations/{conversationId}/read","/api/conversations/{conversationId}/turn","/api/diagnostics","/api/fluctlights","/api/fluctlights/{fluctlightId}","/api/media/{assetId}","/api/platform/ping","/api/providers/endpoints","/api/providers/roles","/api/settings","/auth/login","/auth/logout","/auth/revoke-all","/auth/session","/auth/setup","/health/live","/health/ready"] as const;
