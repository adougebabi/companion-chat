// Generated from packages/browser-client/openapi.json. Do not edit by hand.
export const browserOperations = ["/api/actor-groups","/api/actor-groups/{groupId}/members","/api/actor-groups/{groupId}/members/{actorId}","/api/autonomy-actions/{actionId}/govern","/api/capability-requests","/api/capability-requests/{requestId}/review","/api/conversations","/api/conversations/{conversationId}/messages","/api/conversations/{conversationId}/read","/api/conversations/{conversationId}/turn","/api/diagnostics","/api/diagnostics/export","/api/diagnostics/lifecycle","/api/diagnostics/media-prompts","/api/diagnostics/media-prompts/{mediaIntentId}/retry","/api/diagnostics/model-runs","/api/diagnostics/workflows","/api/diagnostics/workflows/{workflowId}/cancel","/api/diagnostics/workflows/{workflowId}/history","/api/diagnostics/workflows/{workflowId}/pause","/api/diagnostics/workflows/{workflowId}/reset","/api/diagnostics/workflows/{workflowId}/restart","/api/diagnostics/workflows/{workflowId}/resume","/api/diagnostics/workflows/{workflowId}/status","/api/fluctlight-creations/activate","/api/fluctlight-creations/analysis","/api/fluctlights","/api/fluctlights/{fluctlightId}","/api/fluctlights/{fluctlightId}/autonomy-actions","/api/fluctlights/{fluctlightId}/conversation","/api/fluctlights/{fluctlightId}/detail","/api/fluctlights/{fluctlightId}/developing-self","/api/fluctlights/{fluctlightId}/developing-self/{claimId}/forget","/api/fluctlights/{fluctlightId}/developing-self/{claimId}/rollback","/api/fluctlights/{fluctlightId}/events","/api/fluctlights/{fluctlightId}/events/{eventId}/cancel","/api/fluctlights/{fluctlightId}/foundation-revisions","/api/fluctlights/{fluctlightId}/foundation-revisions/rollback","/api/fluctlights/{fluctlightId}/foundation-revisions/{revisionId}/accept","/api/fluctlights/{fluctlightId}/foundation-revisions/{revisionId}/reject","/api/fluctlights/{fluctlightId}/moments","/api/fluctlights/{fluctlightId}/moments/read","/api/fluctlights/{fluctlightId}/presence","/api/fluctlights/{fluctlightId}/relationships/rollback","/api/fluctlights/{fluctlightId}/relationships/{targetActorId}","/api/fluctlights/{fluctlightId}/retire","/api/fluctlights/{fluctlightId}/schedules","/api/fluctlights/{fluctlightId}/schedules/{scheduleId}/cancel","/api/fluctlights/{fluctlightId}/status","/api/fluctlights/{fluctlightId}/wake-up","/api/media/{assetId}","/api/memories/{memoryId}","/api/memories/{memoryId}/forget","/api/moments","/api/moments/{momentId}/comments","/api/moments/{momentId}/hide","/api/moments/{momentId}/reactions","/api/moments/{momentId}/restore","/api/platform/ping","/api/providers","/api/providers/endpoints","/api/providers/endpoints/{endpointId}/models","/api/providers/roles","/api/settings","/auth/login","/auth/logout","/auth/password","/auth/revoke-all","/auth/session","/auth/setup","/auth/setup-status","/health/live","/health/ready"] as const;
export type BrowserFluctlightCreateRequest = { id?: string; name?: string };
export type BrowserFluctlightCreationAnalysisRequest = { description: string };
export type BrowserFluctlightCreationAnalysis = { analysis_id: string; correlation_id: string; schema_version: number; core_persona: Record<string, unknown>; developing_self: Record<string, unknown>; extensions: Record<string, unknown>; initial_goals: Array<Record<string, unknown>>; initial_intentions: Array<Record<string, unknown>>; initial_relationships: Array<Record<string, unknown>> };
export type BrowserFluctlightActivationRequest = { requestId: string; initializationMode: "blank_slate" | "llm_defined"; analysisId?: string; schemaVersion?: number; name?: string; corePersona?: Record<string, unknown>; developingSelf?: Record<string, unknown>; extensions?: Record<string, unknown>; initialGoals?: Array<Record<string, unknown>>; initialIntentions?: Array<Record<string, unknown>>; initialRelationships?: Array<Record<string, unknown>> };
export type BrowserInitializationSource = { id: string; correlation_id: string; source_text: string; source_digest: string; provider_endpoint_id?: string | null; model_id?: string | null; prompt_version: string; schema_version: string; classification: "single" | "multiple" | "unknown"; classification_evidence: Record<string, unknown>; field_derivations: Record<string, unknown>; coverage: Record<string, unknown>; structured_projection: Record<string, unknown>; projection_digest: string; created_at: string; linked_at: string };
export type BrowserFluctlightDetail = ({ initialization_source?: BrowserInitializationSource | null } & Record<string, unknown>);
export type BrowserLifeEventRequest = { kind: string; startAt: string; endAt: string; scene?: string; activity?: string; location?: string; evidenceRefs: Array<string>; expectedLifeContextRevision: string; idempotencyKey: string };
export type BrowserLifeEventCancelRequest = { expectedEventRevision: number; expectedLifeContextRevision: string; idempotencyKey: string };
export type BrowserPresenceRequest = unknown | unknown;
export type BrowserScheduleItemRequest = { startAt: string; endAt: string; activity: string; scene: string; location?: string; itemType?: string; status?: string; priority?: number; flexibility?: number; interruptionCost?: number };
export type BrowserScheduleRequest = { localDate: string; timezone: string; items: Array<BrowserScheduleItemRequest>; evidenceRefs: Array<string>; expectedRevision: number; completedBefore?: string; expectedLifeContextRevision: string; idempotencyKey: string };
export type BrowserScheduleCancelRequest = { expectedRevision: number; expectedLifeContextRevision: string; idempotencyKey: string };
...
export class BrowserClient {
  ...
  async rollbackRelationship(fluctlightId: string, body: { targetActorId: string; profileId?: string; targetRevision: number; expectedRevision: number; evidenceRefs: string[] }): Promise<Record<string, unknown>> { return this.json(`/api/fluctlights/${encodeURIComponent(fluctlightId)}/relationships/rollback`, { method: "POST", body }) as Promise<Record<string, unknown>>; }
