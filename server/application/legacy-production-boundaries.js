...
const BOUNDARIES = [
    {
        ...
        blockers: [
            ...
            {code: 'generic-life-event-flow-missing', detail: 'No modular flow owns the complete generic life-event policy, participant handling, state projection, activity publication, and post-commit effect intents for all routine, schedule, recovery, and timeline sources.'}
        ],
        deletionChecks: [
