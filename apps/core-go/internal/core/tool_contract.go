	...
	return CapabilityDefinition{
		...
		OutputSchema: map[string]any{
			...
			"properties": map[string]any{
				...
				"delivery_status": map[string]any{"type": "string", "enum": []any{"duplicate_suppressed"}},
			},
		},
...
func momentPublishCapabilityDefinition() CapabilityDefinition {
	return CapabilityDefinition{
		...
		OutputSchema: map[string]any{
			...
			"properties": map[string]any{
				"text":        map[string]any{"type": "string", "minLength": 1, "maxLength": 32000},
				"target_kind": map[string]any{"type": "string", "enum": []any{"moment"}},
				"target_ref":  map[string]any{"type": "string", "minLength": 1, "maxLength": 128},
				"replayed":    map[string]any{"type": "boolean"},
			},
		},
	...
	return CapabilityDefinition{
		...
		OutputSchema: map[string]any{
			...
			"properties": map[string]any{
				...
				"status":          map[string]any{"type": "string", "enum": []any{"pending", "running", "completed", "failed"}},
				"target_kind":     map[string]any{"type": "string", "enum": []any{"conversation", "conversation_message", "moment", "wake_up"}},
				"target_ref":      map[string]any{"type": "string", "minLength": 1, "maxLength": 128},
				"replayed":        map[string]any{"type": "boolean"},
			},
		},
...
func NormalizeProviderToolCalls(value any, sourceFactID, providerRequestID string) ([]CapabilityInvocation, error) {
	return normalizeProviderToolCalls(value, sourceFactID, providerRequestID)
}
