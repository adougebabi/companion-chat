...
CREATE TABLE IF NOT EXISTS public.fluctlights (id varchar(128) PRIMARY KEY, created_by_actor_id varchar(128) NOT NULL, initialization_mode varchar(16) NOT NULL, status varchar(16) NOT NULL DEFAULT 'active', current_revision integer NOT NULL DEFAULT 0, lifecycle_revision integer NOT NULL DEFAULT 0, identity jsonb NOT NULL, personality jsonb NOT NULL, behavioral_policy jsonb NOT NULL, life_profile jsonb NOT NULL, provenance jsonb NOT NULL, created_at timestamptz NOT NULL DEFAULT now(), updated_at timestamptz NOT NULL DEFAULT now(), retired_at timestamptz);
