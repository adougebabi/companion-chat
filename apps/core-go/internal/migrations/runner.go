...
CREATE TABLE IF NOT EXISTS public.memories (id varchar(128) PRIMARY KEY, owner_fluctlight_id varchar(128) NOT NULL, type varchar(32) NOT NULL, content text NOT NULL, actor_refs jsonb NOT NULL, conversation_id varchar(128), event_refs jsonb NOT NULL, evidence_refs jsonb NOT NULL, personality_perspectives jsonb NOT NULL DEFAULT '[]', confidence double precision NOT NULL, importance double precision NOT NULL, emotional_significance double precision NOT NULL, visibility varchar(32) NOT NULL, status varchar(32) NOT NULL DEFAULT 'active', revision integer NOT NULL DEFAULT 0, occurred_at timestamptz, created_at timestamptz NOT NULL DEFAULT now(), last_confirmed_at timestamptz, search_document tsvector);
CREATE TABLE IF NOT EXISTS public.memory_revisions (id varchar(128) PRIMARY KEY, memory_id varchar(128) NOT NULL, revision integer NOT NULL, base_revision integer NOT NULL, content text NOT NULL, personality_perspectives jsonb NOT NULL DEFAULT '[]', status varchar(32) NOT NULL, actor_id varchar(128) NOT NULL, evidence_refs jsonb NOT NULL, idempotency_key varchar(256) NOT NULL UNIQUE, created_at timestamptz NOT NULL DEFAULT now());
