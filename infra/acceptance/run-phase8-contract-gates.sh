...
go -C apps/core-go test -mod=readonly -count=1 -json \
  -run 'Test(Phase8|EinoNative|EinoADK|RunADKLoop|ProviderConversation|ProviderWakeUp|ProviderTakeover|ADKLoopSchemaMatrix|RunADKStructuredTask|HandleTurnProductionADKToolLoop)' \
